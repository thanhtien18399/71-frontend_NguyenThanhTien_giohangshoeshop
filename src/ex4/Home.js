  ...
  render() {
    return (
      <div className='container'>
        <h1 className='display-2'>Shose Shop</h1>
        <p className='text-right' 
        data-bs-toggle="modal"
        data-bs-target="#exampleModal"><i className="fa-solid fa-cart-shopping"></i><span className='d-block'>Giỏ Hàng </span></p>
        <ProductList
        addToCart={this.addToCart}
        selectProduct={this.selectProduct}
        prod={this.products}/>
        {this.state.selectProduct &&(<ProductDetail selectProduct={this.state.selectProduct}/>)}
        <Cart 
